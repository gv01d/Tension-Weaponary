...
public class CosmicAngularBoomParticle extends SpriteBillboardParticle {
    ...
    protected CosmicAngularBoomParticle(ClientWorld clientWorld, double d, double e, double f, SpriteProvider spriteProvider) {
    ...
    public static class Factory implements ParticleFactory<AngularColoredParticleEffect> {
        ...
        public Particle createParticle(AngularColoredParticleEffect parameters, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            CosmicAngularBoomParticle streakParticle = new CosmicAngularBoomParticle(clientWorld, d, e, f, this.spriteProvider);
