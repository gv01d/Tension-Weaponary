...
public class LightFlashParticle extends SpriteBillboardParticle {
    private final SpriteProvider spriteProvider;


    protected LightFlashParticle(ClientWorld world, double x, double y, double z, SpriteProvider spriteProvider) {
        super(world, x, y, z);
    ...
    public static class Factory implements ParticleFactory<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            LightFlashParticle lightFlashParticle = new LightFlashParticle(clientWorld, d, e, f, this.spriteProvider);
    ...
    public static class SmallFactory implements ParticleFactory<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            Particle particle = new LightFlashParticle(clientWorld, d, e, f, this.field_50230);
