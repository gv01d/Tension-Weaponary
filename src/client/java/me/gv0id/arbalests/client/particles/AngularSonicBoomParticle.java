...
public class AngularSonicBoomParticle extends SpriteBillboardParticle {
    ...
    protected AngularSonicBoomParticle(ClientWorld clientWorld, double d, double e, double f, SpriteProvider spriteProvider) {
        ...
        float f1 = this.random.nextFloat() * 0.8F + 0.2F;
        this.red = f1;
        this.green = f1;
        this.blue = f1;
    }
    ...
    public void render(VertexConsumer vertexConsumer, Camera camera, float tickDelta) {
        ...
        quaternionf = RotationAxis.POSITIVE_Y.rotationDegrees(this.yaw - 90.0F)
                ...
                .mul(RotationAxis.POSITIVE_X.rotation(90.0F));
    ...
    public static class Factory implements ParticleFactory<AngularColoredParticleEffect> {
        ...
        public Particle createParticle(AngularColoredParticleEffect parameters, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            AngularSonicBoomParticle streakParticle = new AngularSonicBoomParticle(clientWorld, d, e, f, this.spriteProvider);
