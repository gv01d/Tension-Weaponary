...
public class StrafeParticle extends SpriteBillboardParticle {
    private final SpriteProvider spriteProvider;
    private final double windConstantX;
    private final double windConstantY;
    private final double windConstantZ;

    public StrafeParticle(ClientWorld world, double x, double y, double z, SpriteProvider spriteProvider) {
        super(world, x, y, z);
        this.velocityX = 0D;
    ...
    public static class Factory implements ParticleFactory<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType parameters, ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
            return new StrafeParticle(world, x, y, z, this.spriteProvider);
        }
    }
}
