...
public class CopperDiscThirdProjectileVariationTypeProperty implements SelectProperty<ModModelProvider.ItemVariation> {
    public static final Type<CopperDiscThirdProjectileVariationTypeProperty, ModModelProvider.ItemVariation> TYPE = Type.create(
            MapCodec.unit(new CopperDiscThirdProjectileVariationTypeProperty()), ModModelProvider.ItemVariation.CODEC
    );
    ...
    public ModModelProvider.ItemVariation getValue(
        ...
        if (chargedProjectilesComponent == null || chargedProjectilesComponent.isEmpty()) {
            ...
            ItemStack temp = chargedProjectilesComponent.getProjectiles().get(2).copy();
    ...
    @Override
    public Type<CopperDiscThirdProjectileVariationTypeProperty, ModModelProvider.ItemVariation> getType() {
        return TYPE;
    }
}
